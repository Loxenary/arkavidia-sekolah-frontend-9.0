...
import Person from "@images/singer.svg";
interface Contact {
  contact: string;
  person?: string;
}
...
export const ContactPersonSection = ({
  ...
  return (
    <section className="px-12 py-20 flex flex-col gap-10 relative">
      <Image src={Person} alt={"Person Singer"} className="absolute bottom-0 right-10 max-lg:hidden" />
