...
export const CompetitiveProgrammingHeader = () => {
  return (
    <section className="bg-[linear-gradient(90deg,_rgb(11,10,10)_2%,_transparent_1%),_linear-gradient(rgb(11,10,10)_2%,_transparent_1%)] bg-[length:80px_80px] w-full relative bg-yellow300 flex justify-center items-center flex-col pt-40 pb-20 overflow-hidden">
      <Image
        src={Star}
        alt="Star Background"
